...
[data-bs-theme=dark] select.quickgrade {
    color: var(--bs-gray-500, #adb5bd);
    background: var(--bs-gray-1000, #1e1e25) url("/theme/image.php?theme=boost&component=theme&image=dark%2Fcustom-select") right 10px center/8px 10px no-repeat;
    border-color: var(--bs-gray-900, #2e3134);
}
...
[data-bs-theme=dark] .popover-process-monitor.shadow .moodle-dialogue-hd .btn-close:before {
    display: block;
    content: " ";
    background-image: url("/theme/image.php?theme=boost&component=theme&image=dark%2Fclose-button");
    width: 24px;
    height: 24px;
}
...
[data-bs-theme=dark] .fp-pathbar .fp-path-folder {
    background: url("/theme/image.php?theme=boost&component=theme&image=dark%2Fpath_folder") left 3px no-repeat;
}
...
[data-bs-theme=dark] #frontpage-category-combo .coursebox > .info > .coursename a {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Fi%2Fcourse);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.edittag {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Fi%2Fsettings);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.flagasinappropriate {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Fi%2Fflagged);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.removefrommyinterests {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Ft%2Fdelete);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.addtomyinterests {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Ft%2Fadd);
}
...
[data-bs-theme=dark] .course_category_tree .category.with_children.collapsed > .info > .categoryname {
    background-image: url(/theme/image.php?theme=boost&component=theme_boost_magnific&image=dark%2Ft%2Fcollapsed);
}
...
[data-bs-theme=dark] .custom-select,
[data-bs-theme=dark] select.quickgrade {
    background: var(--bs-gray-1000, #1e1e25) url("/theme/image.php?theme=boost&component=local_boost_dark&image=dark%2Fcustom-select") right 10px center/8px 10px no-repeat;
}
...
[data-bs-theme=dark] .moodle-dialogue .moodle-dialogue-wrap .modal-header .btn-close:before,
[data-bs-theme=dark] .moodle-dialogue .moodle-dialogue-wrap .moodle-dialogue-hd .btn-close:before {
    background-image: url("/theme/image.php?theme=boost&component=local_boost_dark&image=dark%2Fclose-button");
}

[data-bs-theme=dark] .fp-pathbar .fp-path-folder {
    background: url("/theme/image.php?theme=boost&component=local_boost_dark&image=dark%2Fpath_folder") left 3px no-repeat;
}
...
[data-bs-theme=dark] #frontpage-category-names .coursebox > .info > .coursename a,
[data-bs-theme=dark] #frontpage-category-combo .coursebox > .info > .coursename a {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=i%2Fcourse);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.edittag {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=i%2Fsettings);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.flagasinappropriate {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=i%2Fflagged);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.removefrommyinterests {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=t%2Fdelete);
}

[data-bs-theme=dark] .path-tag .tag-management-box li a.addtomyinterests {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=t%2Fadd);
}
...
[data-bs-theme=dark] .course_category_tree .category.with_children.collapsed > .info > .categoryname {
    background-image: url(/theme/image.php?theme=boost&component=local_boost_dark&image=t%2Fcollapsed);
}
