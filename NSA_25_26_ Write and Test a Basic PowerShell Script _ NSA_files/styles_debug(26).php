...
.qnbutton.flagged .thispageholder {
    background: transparent url(/theme/image.php?theme=boost&component=quiz&image=flag-on) 15px 0 no-repeat;
}

.qnbutton.invalidanswer .trafficlight {
    background-image: url(/theme/image.php?theme=boost&component=quiz&image=warningtriangle) !important; /* stylelint-disable-line declaration-no-important */
}
